...
\section{Køretid}
Algoritmen er af natur linær, den foretager de nøjagtig samme instruktioner, blot flere gange ved større input. Derfor forventer vi en køretid på $O(n)$. Vi har dog alligevel foretaget en måling og resultatet ses i figur \ref{fig:runtime}. Det ses at køretiden meget præcist er linær.
