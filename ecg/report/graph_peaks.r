...
#pdf("graphs/graph_peaks.pdf")

# draw pulse
plot(mwi, type="l", col = "red", xlim = c(0, 5000), axes = T,  ann = F)

# plot the r peak points
xp <- c(154 ,322 ,479 ,627 ,785 ,953 ,1102,1261,1419,1577,1734,1901,2048,2342,2352,2503,2659,2822,2979,3137,3306,3455,3614,3772,3928,4087,4244,4401,4559,4852,4862)
...
title("R-Peaks", xlab = "Time (s)", ylab = "")
