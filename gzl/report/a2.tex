...
clock frekvens på $9747 Hz$. Vi runder op til $1 kHz$ da vi vil undgå
en clock speed der er for langsom til at følge med sample raten.

Nu ser vi på hvor mange toggles der bliver udført per MWI udregning,
se tabel~\ref{table:toggles}. Vi målte $6548$ toggles for én MWI
udregning, dette er \emph{aktiviteten}.
...
\[  6548 \cdot 1.8 \cdot 10^{-16}F \cdot 1.2 V^2 \cdot 1 kHz = 1.414 nanowatt \]
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    ipoutput   & 33739    & 33605     & 134     \\  \hline
