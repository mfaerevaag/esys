...
Hver instruktion har sin egen binære struktur ift.~dens argumenter. Alle har de en 4-bit opcode som er de 4 MSB. Eksempelvis oversættes en \code{sub} instruktion som følger:

\code{sub \$r0, \$r1, \$r2} $\Rightarrow$ \code{0001 000 001 010 0000000000000000000}
...
% Norsk
Kontrolleren den sentrale komponent i prosessoren. Den styrer hvordan
de andre komponentene skal fungere ved å sette en rekke
kontrollsignaler.

Den mottar 

\subsection{Program Counter}
\subsection{Jump Handler}
\subsection{Instr. Memory}
\subsection{ALU}
