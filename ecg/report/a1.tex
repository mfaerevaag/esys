...
\section{Konklusion} % Norsk
I dette projektet har vi arbeidet med et indlejret system til en ECG maskin. Her har vi simulert input fra en sensor, filtrert og behandlet denne data, for saa aa presentert den til brukeren eller gemt den slik at den kan bli videre analysert.

Vi har lagt vekt paa presentasjonen av dataen. En faktisk ECG maskin har en skjerm der den presenterer dataen der blir behandlet. Hvis den eneste muligheten for aa displaye informasjonen som blir behandlet er aa skrive den til konsollen, laver dette er meget lite brukervenlig grensesnitt. Informasjonen endrer seg meget hurtig, samtidig som den er liten og daarlig organsiert. For aa skape et komplett system har vi gjort et forsoek paa aa lave et mer realistisk loesning. I forsoeket valgte vi aa bruke et biblotek kalt \code{ncurses} der er et enkelt og kompakt bibliotek der kan lage mer komplekse grensesnitt i en terminal. Den krevet lite ressurser, noe som egnet seg godt for et indlejret system som har begrenset med hukommelse/lagring. Ved hjelp av \code{ncurses} har vi lavet et oversiktelig grensesnitt, tilogmed med grafer der gir et uvuderlig visuelt hjelpemiddel. Dette gjoer at personen som administrer maskinen vil hurtig danne seg oversikt over pasientens tilstand og derfor kunne lave bedre vurderinger.

Ytligere har vi gjort utdypende testing og analyse av programmets ydeevne. Kjoeretiden er akseptabel og sammen med at programmet bruket generelt lite ressurser, saa vil si at den er kompatibel med en eventuell hardware loesning i et slikt projekt. Programmet kjoerer fejlfritt og giver de korrekte resultater i foelge vaares fasit. Med det sier vi oss godt tilfredse med vores produkt.
