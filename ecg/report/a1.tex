...
\begin{figure}[H]
  \centering
  \subfigure{\label{fig:raw_good}\includegraphics[width=60mm]{graphs/graph_raw_good.pdf}}
  \subfigure{\label{fig:raw_bad}\includegraphics[width=60mm]{graphs/graph_raw_bad.pdf}}
  \caption{Normal puls, og puls som indikerer kritisk tilstand hos patienten}
\end{figure}

\begin{figure}[H]
  \centering
  \subfigure{\label{fig:mwi_good}\includegraphics[width=60mm]{graphs/graph_mwi_good.pdf}}
  \subfigure{\label{fig:mwi_bad}\includegraphics[width=60mm]{graphs/graph_mwi_bad.pdf}}
  \caption{MWI værdierne efter signal filtrering}
\end{figure}
