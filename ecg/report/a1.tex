...
\caption{Overordnet program flow (stiplede linjer markere valgfri eksekvering)\label{fig:flow}}
\end{figure}
...
\caption{Respektive filterfunktioner\label{fig:filters}}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Normal puls, raw data og det filtrerede MWI\label{fig:graph_good}}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Fundne R-Peaks vist som cirkler på MWI data\label{fig:peaks}}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Visuelt output fra programmet, hvor det ses ud for ``Misses'' hvordan advarsler markeres\label{fig:screenshot}}
\end{figure}
...
\begin{table}[h]
  ...
  \end{tabular}
  \caption{Kodestørrelse (bytes) af forskellige aspekter og optimeringer\label{tbl:codesize}}
\end{table}
...
\begin{figure}[H]
  ...
  \caption{Fundne R-Peaks vist som cirkler på MWI data\label{fig:runtime}}
\end{figure}
